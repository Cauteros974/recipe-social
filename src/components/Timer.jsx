...
const Timer = () => {
    ...
    return(
        <div style={{
            ...
            <button onClick={handleStart} disabled= {isActive} style={{ background: 'none', border: 'none', color: '#2ecc71', cursor: 'pointer'}}>
                <Play size={20}/>
            </button>
            <button onClick={() => setIsActive(false)} style={{background: 'none', border: 'none', color: '#f2c924'}}></button>
        </div>
    )
};
